"""
Run this script to generate sample data for the project.
...
data = {
    ...
    "facility": [
        "City Hospital A","Regional Clinic B","Medical Center C",
        "City Hospital A","Regional Clinic B","Medical Center C",
        "City Hospital A","Regional Clinic B","Medical Center C",
        "City Hospital A","Regional Clinic B","Medical Center C",
    ],
    ...
    "total_amount_aed": [
        2400000,3200000,1800000,
        2700000,3400000,1950000,
        2200000,3600000,1870000,
        2850000,3800000,2100000
    ]
}
